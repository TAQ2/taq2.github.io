export default [
  {
    ...
    to: "08/2019",
    description:
      "Delivered a wide range of web projects relating to city design",
    bullets: [
  ...
  },
  {
    ...
    to: "02/2016",
    description:
      "Tested children's vocabulary games that were redeveloped to transition from the US to the UK market",
    bullets: [
